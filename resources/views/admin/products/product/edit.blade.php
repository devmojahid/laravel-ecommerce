                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{ $product->name }}" name="name" class="form-control" id="basic-default-name"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input name="weight" value="{{ $product->weight }}" class="form-control" type="number" id="html5-number-input">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="barcode" value="{{ $product->barcode }}" class="form-control" id="basic-default-name"
                                        placeholder="Barcode">
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value="{{ $product->product_video_link }}" id="html5-url-input">
                                </div>
                            </div>
                            {{-- Gallery Images --}}
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value="{{ $product->product_audio_link }}" id="html5-url-input">
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value="{{ $product->discount_start }}" id="html5-datetime-local-input">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value="{{ $product->discount_end }}" id="html5-datetime-local-input">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="5" name="summary" type="text" placeholder="Summary"
                                        id="html5-number-input">{{ $product->summary }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control tinymce-editor" rows="10" name="description" type="text" placeholder="Description"
                                        id="html5-number-input">{{ $product->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="meta_title" type="text"
                                        placeholder="Meta Title" value="{{ $product->meta_title }}" id="html5-number-input">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control tinymce-editor" rows="10" name="meta_description" type="text" placeholder="Meta Description"
                                        id="html5-number-input">{{ $product->meta_description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="meta_keywords" type="text"
                                        placeholder="Meta Title" value="{{ $product->meta_keywords }}" id="html5-number-input">
                                </div>
                            </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="vat" class="form-control" value="{{ $product->vat }}" type="number"
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="tax" class="form-control" value="{{ $product->tax }}" type="number"
                                        id="flexSwitchCheckChecked">
                                </div>
                            </div>
                        </div>

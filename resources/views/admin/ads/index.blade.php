                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($ads as $key=>$ad)
                                    <tr>
                                        ...
                                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> {{ $ad->title }} </td>
                                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <img width="50" height="50" src="{{ $ad->image }}" alt=""></td>
                                        <td><div class="" style="
                                            width: 25px;
                                            height: 25px;
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('ads.edit',$ad->id) }}" href="javascript:void(0);"><i
                                                            class="bx bx-edit-alt me-1"></i> Edit</a>
                                                    <a class="dropdown-item" href="{{ route('ads.delete',$ad->id) }}"><i
                    ...
                    <div class="card-body">
                        <form action="{{ route("ads.store") }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="url" class="form-control" id="basic-default-fullname" >
                            </div>
